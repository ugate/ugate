...
public class PositionSettings extends ControlPane {
	...
	private UGateTextView sonarAnglePriority;
	private UGateTextView pirAnglePriority;
	private UGateTextView mwAnglePriority;
	private UGateTextView laserAnglePriority;
...
// TODO : Add text view with bean path adapter for POsitionSettings
...
//		add(camCell, 0, 0);
	...
	protected void addColumn2() {
		final GridPane grid = new GridPane();
		//####### Sonar #######
//		sonarAnglePriority = new UGateTextView(
...
//		//####### PIR #######
//		pirAnglePriority = new UGateTextView(
...
//		add(cell, 1, 0);
	...
	protected void addColumn3() {
		final GridPane grid = new GridPane();
		//####### Microwave #######
//		mwAnglePriority = new UGateTextView(
...
//		//####### Laser #######
//		laserAnglePriority = new UGateTextView(
...
//		add(cell, 2, 0);
	 ...
	 */
	protected void addPriorityValueListener(final UGateTextView control) {
		control.valueProperty().addListener(new ChangeListener<Object>() {
			...
			public void changed(final ObservableValue<? extends Object> observable, 
				...
				// swap old value 
		        final List<UGateTextView> a = Arrays.asList(sonarAnglePriority, pirAnglePriority, 
