...
//		addSelect(cmdForm, RemoteNodeType.GATE_ACCESS_ON, rn, "Gate State (open/close):", onOff);
		...
		addRange(sForm, RemoteNodeType.SONAR_PIR_ANGLE_PAN, rn, 0, 181, "Sonar/PIR Pan Angle:");
		addRange(sForm, RemoteNodeType.SONAR_PIR_ANGLE_TILT, rn, 0, 181, "Sonar/PIR Tilt Angle:");
