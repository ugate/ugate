...
public class PositionSettings extends ControlPane {
	...
	protected void addColumn1() {
		...
		grid.setVgap(0d);
		// cam pan
		final Label panHeader = createLabel(KEYS.CAM_PAN);
		...
		// sonar/pir pan
		final Label sonarPirPanHeader = createLabel(KEYS.SONAR_PIR_PAN);
		...
		// microwave pan
		final Label headerMW = createLabel(KEYS.MW_PAN);
		...
		// laser calibration
		final Label headerLaser = createLabel(KEYS.LASER_CALIBRATION);
	...
	protected void addColumn2() {
		...
		// cam sonar pan
		final Label camSonarPanHeader = createLabel(KEYS.CAM_PAN_SONAR);
		...
		// cam PIR pan
		final Label pirPanHeader = createLabel(KEYS.CAM_PAN_PIR);
		...
		// cam PIR tilt
		final Label pirTiltHeader = createLabel(KEYS.CAM_TILT_PIR);
	...
	protected void addColumn3() {
		...
		// cam microwave pan
		final Label mwPanHeader = createLabel(KEYS.CAM_PAN_MW);
		...
		// cam microwave tilt
		final Label mwTiltHeader = createLabel(KEYS.CAM_TILT_MW);
		...
		// cam laser pan
		final Label laserPanHeader = createLabel(KEYS.CAM_PAN_LASER);
		...
		// cam laser tilt
		final Label laserTiltHeader = createLabel(KEYS.CAM_TILT_LASER);
